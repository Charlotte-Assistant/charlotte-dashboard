...
export default function TasksPage() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      ...
      {/* Stats Footer */}
      <div className="mt-6 px-5 py-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-gray-200 dark:border-gray-700/60">
        <div className="flex items-center justify-between text-sm">
          <div className="flex gap-6">
            <span className="text-gray-600 dark:text-gray-400">
              <span className="font-semibold text-red-600 dark:text-red-400">{tasksData.stats.byPriority.critical || 0}</span> Critical
            </span>
            <span className="text-gray-600 dark:text-gray-400">
              <span className="font-semibold text-orange-600 dark:text-orange-400">{tasksData.stats.byPriority.high || 0}</span> High
            </span>
            <span className="text-gray-600 dark:text-gray-400">
              <span className="font-semibold text-yellow-600 dark:text-yellow-400">{tasksData.stats.byPriority.medium || 0}</span> Medium
            </span>
            <span className="text-gray-600 dark:text-gray-400">
              <span className="font-semibold text-green-600 dark:text-green-400">{tasksData.stats.byPriority.low || 0}</span> Low
            </span>
          </div>
